...
tags: [Wan 3.0, 阿里, 通义, 视频生成]
summary: 「阿里通义实验室Wan 3.0于8月6日开公测、8月10日杭州发布活动正式上线：单镜30秒（Wan 2.7为15秒上限）；全模态输入——PDF、PPT、Excel、网页均可作为输入源，生成文档转视频；API计价¥0.30–1.20/秒（480P–1080P）。」
pinned: true
